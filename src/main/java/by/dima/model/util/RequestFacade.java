...
public class RequestFacade {
    ...
    private final ForDeserializable<AnswerDTO> forDeserializableAnswerDTO;

    public RequestFacade(ForDeserializable<AnswerDTO> forDeserializableAnswerDTO, ForSerializableObject<AuthRequestDTO> authSerialize, Clientable clientable) {
